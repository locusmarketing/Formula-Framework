...
function hybrid_register_widgets() {
	...
	/* Load the latest WOD widget class. */
	require_once( trailingslashit( HYBRID_CLASSES ) . 'widget-latest-wod.php' );
	
	/* Load the featured content widget class. */
	require_once( trailingslashit( HYBRID_CLASSES ) . 'widget-featured-content.php' );
	
	/* Load the contact us widget class. */
	require_once( trailingslashit( HYBRID_CLASSES ) . 'widget-contact-us.php' );
	...
	/* Register the latest WOD widget. */
	register_widget( 'Hybrid_Widget_Latest_WOD' );

	/* Register the Featured Content widget. */
	register_widget( 'Hybrid_Widget_Featured_Content' );
	
	/* Register the Contact Us widget. */
	register_widget( 'Hybrid_Widget_Contact_Us' );
}
