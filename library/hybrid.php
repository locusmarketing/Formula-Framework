...
class Hybrid {
	...
	function extensions() {
		...
		/* Load the FWF Membership extension if supported. */
		require_if_theme_supports( 'fwf-membership', trailingslashit( HYBRID_EXTENSIONS ) . 'membership.php' );
	}
	...
	function default_filters() {
		...
		/* Remove the WordPress generator notice */
