...
function theme_layouts_get_layout() {
	...
	if( in_array($post_type, array('training-plan', 'workout') ) )
		$layout = 'layout-1c';
...
function theme_layouts_strings() {
	...
	$strings = array(
		'default' => __( 'Default (One Column)', 'theme-layouts' ),
	...
	<div class="post-layout">
		...
		<div class="post-layout-wrap">
			<ul>
				...
				<li><input type="radio" name="post-layout" id="post-layout-2c-l" value="2c-l" checked="checked" /> <label for="post-layout-2c-l"><?php _e( 'Default (Two Column)' ); ?></label></li>
				<?php else: ?>
...
function theme_layouts_customize_register( $wp_customize ) {
	...
	if ( true === $args['customize'] ) {
		...
		$wp_customize->add_section(
			'layout',
			array(
				'title'      => esc_html__( 'Layout, Header, & More', 'theme-layouts' ),
				'priority'   => 190,
				'capability' => 'edit_theme_options'
			)
		);
		...
		$wp_customize->add_setting( "theme_layout_header", get_theme_mod( 'theme_layout_header', 'one-third' ) );
		$wp_customize->add_control(
			'theme-layout-header-control',
			array(
				'label'    => esc_html__( 'Header Layout', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_layout_header',
				'type'     => 'select',
				'choices'  => array( 'half' => '1/2 + 1/2', 'one-third' => '1/3 + 2/3', 'one-fourth' => '1/4 + 3/4')
			)
		);

		$wp_customize->add_setting( "theme_layout_blog", get_theme_mod( 'theme_layout_blog', $args['default'] ) );
		$wp_customize->add_control(
			'theme-layout-blog-control',
			array(
				'label'    => esc_html__( 'Blog Layout', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_layout_blog',
				'type'     => 'select',
				'choices'  => $layout_choices
			)
		);
		
		/* Add the homepage opening content option */
		$wp_customize->add_setting( "theme_home_opening", get_theme_mod( 'theme_home_opening', $args['default'] ) );
		$wp_customize->add_control(
			'theme-home-opening-control',
			array(
				'label'    => esc_html__( 'Home Opening Content', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_home_opening',
				'type'     => 'select',
				'choices'  => array( 'slideshow' => 'Slideshow (skip 1-2 below)', 'bg_content' => 'Content with background')
			)
		);
		
		/* Add the slide content aligment */
		$wp_customize->add_setting( "theme_slide_content_align", get_theme_mod( 'theme_slide_content_align', $args['default'] ) );
		$wp_customize->add_control(
			'theme-home-opening-control',
			array(
				'label'    => esc_html__( 'Content Alignment', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_slide_content_align',
				'type'     => 'select',
				'choices'  => array( 'left' => 'Left', 'center' => 'Center', 'right' => 'Right')
			)
		);
		
		/* Add the video URL setting. */
		$wp_customize->add_setting( "theme_opening_video" );
		$wp_customize->add_control(
			'theme-opening-video-control',
			array(
				'label'    => esc_html__( '1. Video Path (exclude extension)', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_opening_video',
				'type' => 'url',
				'input_attrs' => array(
			         'class' => 'fwf-customizer-input',
			         'style' => '',
			         'placeholder' => __( '//video-file-path-no-extension' )
			    )
			)
		);
		
		/* Add the opening content setting. */
		$wp_customize->add_setting( "theme_opening_content" );
		$wp_customize->add_control(
			'theme-opening-content-control',
			array(
				'label'    => esc_html__( '2. Opening Content', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_opening_content',
				'type' => 'textarea',
				'input_attrs' => array(
			         'class' => 'fwf-customizer-textarea',
		...
		$wp_customize->add_setting( "theme_hide_h_address" );
		$wp_customize->add_control(
			'theme-hide-h-address-control',
			array(
				'label'    => esc_html__( 'Hide Address in Header', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_hide_h_address',
				'type'     => 'checkbox'
			)
		);
		$wp_customize->add_setting( "theme_hide_h_phone" );
		$wp_customize->add_control(
			'theme-hide-h-phone-control',
			array(
				'label'    => esc_html__( 'Hide Phone in Header', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_hide_h_phone',
				'type'     => 'checkbox'
			)
		);
		$wp_customize->add_setting( "theme_hide_h_social" );
		$wp_customize->add_control(
			'theme-hide-h-social-control',
			array(
				'label'    => esc_html__( 'Hide Social Icons in Header', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_hide_h_social',
				'type'     => 'checkbox'
			)
		);
		
		/* Hide the cart link from the nav */
		$wp_customize->add_setting( "theme_hide_cart_nav_link" );
		$wp_customize->add_control(
			'theme-hide-cart-nav-link-control',
			array(
				'label'    => esc_html__( 'Hide Cart Link from the Nav', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_hide_cart_nav_link',
				'type'     => 'checkbox',
				'extra'    => __( '', 'fitnessthemes' )
			)
		);
		
		/* Add the header shrinking option */
		$wp_customize->add_setting( "theme_shrink_header" );
		$wp_customize->add_control(
			'theme-shrink-header-control',
			array(
				'label'    => esc_html__( 'Shrink Header on Scroll', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_shrink_header',
				'type'     => 'checkbox',
				'extra'    => __( 'Shrink the header when you are scrolling the page.', 'fitnessthemes' )
			)
		);
		
		/* Add the login/logout nav link option */
		$wp_customize->add_setting( "theme_auth_nav_link" );
		$wp_customize->add_control(
			'theme-auth-nav-link-control',
			array(
				'label'    => esc_html__( 'Add Login/Logout to the main menu', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_auth_nav_link',
				'type'     => 'checkbox',
				'extra'    => __( '', 'fitnessthemes' )
			)
		);
		
		/* Add the logo centering option */
		$wp_customize->add_setting( "theme_center_logo" );
		$wp_customize->add_control(
			'theme-center-logo-control',
			array(
				'label'    => esc_html__( 'Center Logo in Nav Bar', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_center_logo',
				'type'     => 'checkbox',
				'extra'    => __( 'Tick to enable the center alignment of your logo', 'fitnessthemes' )
			)
		);
		
		/* Add the Shrunk logo max height setting. */
		$wp_customize->add_setting( "theme_shrunk_logo_height", array( 'default' => 80 ) );
		$wp_customize->add_control(
			'theme-shrunk-logo-h-control',
			array(
				'label'    => esc_html__( 'Shrunk Logo Max Height (px)', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_shrunk_logo_height'
			)
		);
		
		/* Add the container max-width setting. */
		$wp_customize->add_setting( "theme_container_maxwidth", array( 'default' => 990 ) );
		$wp_customize->add_control(
			'theme-container-maxwidth-control',
			array(
				'label'    => esc_html__( 'Container Max Width (px)', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_container_maxwidth'
			)
		);
		
		/* Add the slim menu resize width setting. */
		$wp_customize->add_setting( "theme_slimmenu_resizewidth", array( 'default' => 800 ) );
		$wp_customize->add_control(
			'theme-slimmenu-resizewidth-control',
			array(
				'label'    => esc_html__( 'Slimmenu Resize Width (px)', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_slimmenu_resizewidth'
			)
		);
		
		/* Add the social media links */
		$wp_customize->add_setting( "theme_url_facebook", array('default' => '#') );
		$wp_customize->add_control(
			'theme-url-facebook-control',
			array(
				'label'    => esc_html__( 'Facebook URL', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_url_facebook',
				'type'     => 'text',
				'input_attrs' => array(
			         'class' => 'fwf-customizer-input',
			         'style' => '',
		...
		$wp_customize->add_setting( "theme_url_twitter", array('default' => '#') );
		$wp_customize->add_control(
			'theme-url-twitter-control',
			array(
				'label'    => esc_html__( 'Twitter URL', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_url_twitter',
				'type'     => 'text',
				'input_attrs' => array(
			         'class' => 'fwf-customizer-input',
			         'style' => '',
		...
		$wp_customize->add_setting( "theme_url_youtube", array('default' => '') );
		$wp_customize->add_control(
			'theme-url-youtube-control',
			array(
				'label'    => esc_html__( 'YouTube URL', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_url_youtube',
				'type'     => 'text',
				'input_attrs' => array(
			         'class' => 'fwf-customizer-input',
			         'style' => '',
		...
		$wp_customize->add_setting( "theme_url_yelp", array('default' => '#') );
		$wp_customize->add_control(
			'theme-url-yelp-control',
			array(
				'label'    => esc_html__( 'Yelp URL', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_url_yelp',
				'type'     => 'text',
				'input_attrs' => array(
			         'class' => 'fwf-customizer-input',
			         'style' => '',
		...
		$wp_customize->add_setting( "theme_url_instagram", array('default' => '#') );
		$wp_customize->add_control(
			'theme-url-instagram-control',
			array(
				'label'    => esc_html__( 'Instagram URL', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_url_instagram',
				'type'     => 'text',
				'input_attrs' => array(
			         'class' => 'fwf-customizer-input',
			         'style' => '',
		...
		$wp_customize->add_setting( "theme_url_googleplus", array('default' => '#') );
		$wp_customize->add_control(
			'theme-url-googleplus-control',
			array(
				'label'    => esc_html__( 'Google+ URL', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_url_googleplus',
				'type'     => 'text',
				'input_attrs' => array(
			         'class' => 'fwf-customizer-input',
			         'style' => '',
		...
		$wp_customize->add_setting( "theme_url_member_login", array('default' => '') );
		$wp_customize->add_control(
			'theme-url-member-login-control',
			array(
				'label'    => esc_html__( 'External Login URL', 'theme-layouts' ),
				'section'  => 'layout',
				'settings' => 'theme_url_member_login',
				'type'     => 'text',
				'input_attrs' => array(
			         'class' => 'fwf-customizer-input',
			         'style' => '',
